...
export const MTN_SMS_CONFIG = {
  ...
  CONSUMER_KEY: import.meta.env.VITE_MTN_CONSUMER_KEY || 'M3Z4DO7pMG4uPEhV9bkCLyd7c0einoq7',
  CONSUMER_SECRET: import.meta.env.VITE_MTN_CONSUMER_SECRET || 'ISPRytvCDIJ7P5Ed',
  
  // Mode test (désactive l'API réelle)
  TEST_MODE: import.meta.env.VITE_MTN_TEST_MODE === 'true' || false,
  
  // Configuration SMS
  SERVICE_CODE: import.meta.env.VITE_MTN_SERVICE_CODE || 'ACAD-HUB',
  SENDER_ADDRESS: import.meta.env.VITE_MTN_SENDER_ADDRESS || 'ACAD-HUB',
