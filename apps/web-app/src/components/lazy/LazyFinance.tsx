...
const financeImport = () => import('../dashboard/Finance');
const Finance = lazy(financeImport);

const LazyFinance: React.FC = () => {
        ...
        <div className="min-h-screen flex items-center justify-center">
          <div className="text-center p-8">
            ...
            <p className="text-gray-600 dark:text-gray-400 mb-4">
              Impossible de charger le module Finance
            </p>
            <button
              onClick={retry}
      ...
      <Suspense 
        fallback={
          <FastModuleLoader 
            moduleName="Finance"
            icon={DollarSign}
            description="Chargement du module financier..."
            showMinimal={false}
          />
        }
      >
